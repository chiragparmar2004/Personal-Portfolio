...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${backendUrl}/skill/getall`, {
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${backendUrl}/skill/add`, data, {
      withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(`${backendUrl}/skill/delete/${id}`, {
      withCredentials: true,
    });
