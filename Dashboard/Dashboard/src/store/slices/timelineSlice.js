...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${backendUrl}/timeline/getall`, {
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${backendUrl}/timeline/add`, data, {
      withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(`${backendUrl}/timeline/delete/${id}`, {
      withCredentials: true,
    });
    dispatch(
