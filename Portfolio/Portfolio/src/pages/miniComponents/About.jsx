        ...
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          <div className="flex justify-center items-center">
            <img
              src="/23.jpg"
              alt="avatar"
              className="bg-white p-2 sm:p-4 rotate-[-11deg] h-[240px] sm:h-[340px] md:h-[350px] lg:h-[450px]"
            />
          </div>
          <div className="flex justify-center flex-col tracking-[1px] text-xl gap-5">
            <p>
              My name is Chirag Parmar I will graduate in Computer Science
              Engineering from Ahmedabad University around 2025. I work as a web
